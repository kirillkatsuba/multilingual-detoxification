...
# ==============================================================================
# Strict Multilingual Instructions
# ==============================================================================
LANG_INSTRUCTIONS = {
...
class MT0Detoxifier:
    """
    A class for detoxifying text using the MT0 model with strict language-specific prompts.
    """
    ...
    def detoxify_batch(
        ...
        # Prepare prompts using strict instructions
        batch_texts =[
...
def main():
    parser = argparse.ArgumentParser(
        description="Detoxify text using upgraded MT0 baseline model (Instructions Only)"
    )
    parser.add_argument(
        "--input_path",
        type=str,
